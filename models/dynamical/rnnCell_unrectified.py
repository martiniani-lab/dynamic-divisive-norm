...
class rnnCell_uncrectified(nn.Module):
    def __init__(
        self,
        input_size: int,
        hidden_size: int,
        ...
        super(rnnCell_uncrectified, self).__init__()
    ...
    def dt_tauy(self):
        return rnnCell_uncrectified.tau_func(self.param_dt_tauy, self.dt_tau_max_y, self.beta)

    def dt_taua(self):
        return rnnCell_uncrectified.tau_func(self.param_dt_taua, self.dt_tau_max_a, self.beta)
    
    def dt_taub0(self):
        return rnnCell_uncrectified.tau_func(self.param_dt_taub0, self.dt_tau_max_b, self.beta)
    
    def dt_taub1(self):
        return rnnCell_uncrectified.tau_func(self.param_dt_taub1, self.dt_tau_max_b, self.beta)
